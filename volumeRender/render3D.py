...
#
#
# inDir = dataDir + 'cosmo_sims/ramses_256/'
inDir = dataDir + 'cosmo_sims/cholla_pm/cosmo_256_hydro/'
...
snapKey = str(nSnap)
nPoints = 256
# data_ramses = load_snapshot_ramses( nSnap, nPoints, inDir )



# gadgetDir = dataDir + 'cosmo_sims/gadget/256_hydro/h5_files/'
# densityFileName = 'gridFields/snapshot_{0:03}_grid_CIC.h5'.format( nSnap )
# densFile = h5.File( gadgetDir + densityFileName )
# dens_dm_gad = densFile['dm/density'][...]
# dens_gas_gad = densFile['gas/density'][...]
...
# dens_dm = data_ramses['dm']['density']
# dens_gas = data_ramses['gas']['density']

dens_dm = data_all['dm']['density'][...]
dens_gas = data_all['grid']['density'][...]


plotData_h_256 = prepare_data( nSnap, dens_dm, log=True )
plotData_h_256_1 = prepare_data( nSnap, dens_gas, log=True )
