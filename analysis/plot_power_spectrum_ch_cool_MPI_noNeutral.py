...
fileName = outDir + 'ps_{0}_cool_uv.png'.format( nPoints )
...
if show_dm:
  ax1.text(0.96, 0.93, 'Dark Matter Power Spectrum\nComparison to Enzo', fontsize=17, horizontalalignment='right', verticalalignment='center', transform=ax1.transAxes, **hfont)
ax3.text(0.96, 0.93, 'Gas Power Spectrum\nComparison to Enzo', fontsize=17, horizontalalignment='right', verticalalignment='center', transform=ax3.transAxes, **hfont)
