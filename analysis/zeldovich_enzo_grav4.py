...
data_name = 'VL_PPMP_eta0.010_beta0.00_grav4'
...
enzoDir = dataDir + 'cosmo_sims/enzo/ZeldovichPancake_grav4/'
...
ax = ax_list[0]
ax.plot( x, data_en[0], linewidth=lw, label='Enzo'    )
# ax.plot( x, data_en_1[0], linewidth=1, label='Enzo_HLLC noDE'    )


ax = ax_list[1]
ax.plot( x, data_en[1], linewidth=lw )
# ax.plot( x, data_en_1[1], linewidth=1 )

ax = ax_list[2]
ax.plot( x, data_en[2], linewidth=lw )
