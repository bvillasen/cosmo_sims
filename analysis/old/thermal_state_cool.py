...
chollaDir_uv = dataDir + 'cosmo_sims/cholla_pm/256_cool/data/'
...
for nSnap in snapshots:
  ...
  if plot_metals: fig, ax_l = plt.subplots(nrows=2, ncols=4, figsize=(40,16))
  else:  fig, ax_l = plt.subplots(nrows=2, ncols=2, figsize=(20,16))
  x_min = -2
  x_max = 3
  x_min_h = -11
  x_max_h = 3
