...
outDir = cosmo_dir + 'figures/phase_diagram/uvb/'

chollaDir_metals = dataDir + 'cosmo_sims/cholla_pm/256_cool/data_metals/'
chollaDir_0 = dataDir + 'cosmo_sims/cholla_pm/256_cool/data_de02_limitEk/'
chollaDir_1 = dataDir + 'cosmo_sims/cholla_pm/256_cool/data_de02/'
...
for nSnap in snapshots:
  ...
  ncols = 4
  fig, ax_l = plt.subplots(nrows=2, ncols=ncols, figsize=(10*ncols,16))
  x_min = -2
  x_max = 3
  x_min_h = -11
  x_max_h = 3
  ...
  ax.set_ylabel(r'Log Temperature $[K]$', fontsize=15 )
  ax.set_xlabel(r'Log Gas Overdensity', fontsize=15 )
  ax.set_title( " CHOLLA Gas DE_PREVIOUS  DE_LIMIT=0.02 LIMIT_EK T={0:.2e}   d={1:.2e}".format( temp_avrg_ch_uv_0, dens_avrg_ch_uv_0))
  ax.set_xlim(x_min, x_max)
  ax.set_ylim(-1, y_max)
  ...
  ax.set_ylabel(r'Log Temperature $[K]$', fontsize=15 )
  ax.set_xlabel(r'Log Neutral Hydrogen Overdensity', fontsize=15 )
  ax.set_title( " CHOLLA Neutral Hydrogen DE_PREVIOUS  DE_LIMIT=0.02 LIMIT_EK T={0:.2e}   d={1:.2e}".format( temp_avrg_ch_uv_0, dens_H_avrg_ch_uv_0))
  ax.set_xlim(x_min_h, x_max_h)
  ax.set_ylim(-1, y_max)
  # 
  ...
  ax.set_ylabel(r'Log Temperature $[K]$', fontsize=15 )
  ax.set_xlabel(r'Log Gas Overdensity', fontsize=15 )
  ax.set_title( " CHOLLA Gas DE_PREVIOUS  DE_LIMIT=0.02  T={0:.2e}   d={1:.2e}".format( temp_avrg_ch_uv_1, dens_avrg_ch_uv_1))
  ax.set_xlim(x_min, x_max)
  ax.set_ylim(-1, y_max)
  
  plt.subplot(2, ncols, ncols+3)
  ax = plt.gca()
  ax.clear()
  ...
  ax.set_ylabel(r'Log Temperature $[K]$', fontsize=15 )
  ax.set_xlabel(r'Log Neutral Hydrogen Overdensity', fontsize=15 )
  ax.set_title( " CHOLLA Neutral Hydrogen DE_PREVIOUS  DE_LIMIT=0.02  T={0:.2e}   d={1:.2e}".format( temp_avrg_ch_uv_1, dens_H_avrg_ch_uv_1))
  ax.set_xlim(x_min_h, x_max_h)
  ax.set_ylim(-1, y_max)
  # 
  ...
  ax.set_ylabel(r'Log Temperature $[K]$', fontsize=15 )
  ax.set_xlabel(r'Log Gas Overdensity', fontsize=15 )
  ax.set_title( " CHOLLA Gas DE_PRESSURE  DE_LIMIT=0.02   T={0:.2e}   d={1:.2e}".format( temp_avrg_ch_uv_2, dens_avrg_ch_uv_2))
  ax.set_xlim(x_min, x_max)
  ax.set_ylim(-1, y_max)
  
  plt.subplot(2, ncols, ncols+4)
  ax = plt.gca()
  ax.clear()
  ...
  ax.set_ylabel(r'Log Temperature $[K]$', fontsize=15 )
  ax.set_xlabel(r'Log Neutral Hydrogen Overdensity', fontsize=15 )
  ax.set_title( " CHOLLA Neutral Hydrogen  DE_PRESSURE  DE_LIMIT=0.02  T={0:.2e}   d={1:.2e}".format( temp_avrg_ch_uv_2, dens_H_avrg_ch_uv_2))
  ax.set_xlim(x_min_h, x_max_h)
  ax.set_ylim(-1, y_max)
