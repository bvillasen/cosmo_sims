...
enzoDir_uv = enzoDir + '256_hydro_grackle/h5_files/'
...
for nSnap in snapshots:
  ...
  data['cholla_uv'][2] =  HII_dens_proj_ch * 0.939
  data['cholla_uv'][3] =  HeI_dens_proj_ch
  data['cholla_uv'][4] =  HeII_dens_proj_ch * 0.91
  data['cholla_uv'][5] =  HeIII_dens_proj_ch * 1.025
  data['cholla_uv'][6] =  e_dens_proj_ch * 0.93
  data['cholla_uv'][7] =  metal_dens_proj_ch
  data['cholla_uv'][8] = gasEnergy_proj_ch * m
