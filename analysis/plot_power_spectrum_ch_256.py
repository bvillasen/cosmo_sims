...
enzoDir = dataDir + 'cosmo_sims/enzo/256_hydro_daLimit/h5_files/'
...
fileName = outDir + 'ps_256_daLim.png'

# snapshots = [ 0, 2, 4, 7, 10, 13, 16, 20, 25, 30]
snapshots = [ 0, 2, 5, 10, 14]
fig = plt.figure(0)
...
for i,nSnap in enumerate(snapshots):
  ...
  print ' Enzo: ', nSnap
  data_enzo = load_snapshot_enzo( nSnap, enzoDir, dm=False)
